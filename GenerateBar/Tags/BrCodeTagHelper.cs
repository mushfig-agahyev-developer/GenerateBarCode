...
namespace GenerateBar
{
    ...
    [HtmlTargetElement("brcode")]
    public class BrCodeTagHelper : TagHelper
    {
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
           ...
           // string path = "C:/Users/Code/source/repos/GenerateBar/GenerateBar/wwwroot/image/brcode";
            using (var bitmap = new Bitmap(pixelData.Width, pixelData.Height, System.Drawing.Imaging.PixelFormat.Format32bppRgb))
            {
                using (var memoryStream = new MemoryStream())
                {
                    ...
                    string filepath = @"C:\Users\Code\source\repos\GenerateBar\GenerateBar\wwwroot\image\brcode\" + myfilename + ".png";
